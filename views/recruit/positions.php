...
<div class="container u-bg-overlay__inner" style="background:#fff;padding:30px 0;border-top:4px solid #90b205" ng-init="get_positions(<?php echo (int) Session::get('id');?>)">
  ...
  <div class="col-md-8" style="margin:0 auto;float:none" ng-cloak>
	...
	<select value="" required class="form-control" name="position_category" ng-model="user_details.position_category" onfocus="$('.alert').hide();">
	...
	<select ng-show="user_details.position_category !='0'" required class="form-control" name="position_applied_for" ng-model="user_details.position_applied_for" onfocus="$('.alert').show();" required id="position_applied_for">
