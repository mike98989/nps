        <div class="content" ng-controller="hrApplicantsController" style="padding-top:7px">
            <div class="container-fluid" ng-init="get_applicants(type='unverified',category='<?php echo $_GET['category'];?>',state='<?php echo $_GET['state'];?>',age='<?php echo $_GET['age'];?>',search_name='<?php echo $_GET['search_name'];?>'); get_positions(); get_all_states()">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                              ...
                              <h4 class="title" style="color:#799A4D;text-align:center">All Unverified Applicants</h4>
                                <p class="category" style="color:#A2CD6A;text-align: center">A comprehensive list of all unverified applicants</p>
                              <hr>
